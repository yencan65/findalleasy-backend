// server/adapters/searchDemirsaglik.js
// ============================================================================
// DEMIRSAGLIK ADAPTER — S200 HARDENED (DRIFT-SAFE, ZERO-CRASH, NO-FAKE)
...
// ZERO DELETE: existing exports preserved (searchDemirsaglik + aliases)
// ============================================================================
...
const PROVIDER_KEY = "demirsaglik";
const ADAPTER_KEY = "demirsaglik_insurance";
const PROVIDER_FAMILY = "insurance";
const BASE = "https://www.demirsaglik.com.tr";
const LIST_URL = "https://www.demirsaglik.com.tr/urunler";
...
function detectCategory(title = "", desc = "") {
  ...
  if (/tamamlayıcı|supplementary/.test(t)) return "supplementary_health";
  if (/özel sağlık|sağlık|health/.test(t)) return "health_insurance";
  if (/yatarak|inpatient/.test(t)) return "inpatient_insurance";
  if (/ayakta|outpatient/.test(t)) return "outpatient_insurance";
...
// MAIN ADAPTER — S200
// ============================================================================
export async function searchDemirsaglik(query, regionOrOptions = "TR") {
  const t0 = Date.now();
...
// Aliases — zero delete
export const searchDemirsaglikScrape = searchDemirsaglik;
export const searchDemirsaglikAdapter = searchDemirsaglik;

export default { searchDemirsaglik };
