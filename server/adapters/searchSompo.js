// server/adapters/searchSompo.js
// ============================================================================
// SOMPO ADAPTER — S200 HARDENED (DRIFT-SAFE, ZERO-CRASH, NO-FAKE)
...
// ZERO DELETE: searchSompo / searchSompoScrape / searchSompoAdapter export’ları korunur
// ============================================================================
...
const PROVIDER_KEY = "sompo";
const ADAPTER_KEY = "sompo_insurance";
const PROVIDER_FAMILY = "insurance";
const BASE = "https://www.sompo.com.tr";
...
function detectCategory(title = "", desc = "") {
  ...
  if (/sağlık|health|medical|tamamlayıcı/.test(t)) return "health_insurance";
  ...
  if (/iş yeri|ticari|business/.test(t)) return "business_insurance";
...
// MAIN ADAPTER — S200
// ============================================================================
export async function searchSompo(query, regionOrOptions = "TR") {
  const t0 = Date.now();
...
// Aliases — Zero-delete
export const searchSompoScrape = searchSompo;
export const searchSompoAdapter = searchSompo;

export default { searchSompo };
