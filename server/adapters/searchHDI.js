// server/adapters/searchHDI.js
// ============================================================================
// HDI ADAPTER — S200 HARDENED (DRIFT-SAFE, ZERO-CRASH, NO-FAKE)
...
// ZERO DELETE: existing exports preserved (searchHDI + aliases)
// ============================================================================
...
const PROVIDER_KEY = "hdi";
const ADAPTER_KEY = "hdi_insurance";
const PROVIDER_FAMILY = "insurance";
const BASE = "https://www.hdisigorta.com.tr";
const LIST_URL = "https://www.hdisigorta.com.tr/urunler";
...
function detectCategory(title = "", desc = "") {
  ...
  if (/kasko|trafik|oto|araç|arac|otomobil|motor/.test(t)) return "car_insurance";
...
// MAIN ADAPTER — S200
// ============================================================================
export async function searchHDI(query, regionOrOptions = "TR") {
  const t0 = Date.now();
...
// Aliases — zero delete
export const searchHDIScrape = searchHDI;
export const searchHDIAdapter = searchHDI;

export default { searchHDI };
