// server/adapters/searchAnadolu.js
// ============================================================================
// ANADOLU ADAPTER — S200 HARDENED (DRIFT-SAFE, ZERO-CRASH, NO-FAKE)
...
// ZERO DELETE: existing exports preserved (searchAnadolu + aliases)
// ============================================================================
...
const PROVIDER_KEY = "anadolu";
const ADAPTER_KEY = "anadolu_insurance";
const PROVIDER_FAMILY = "insurance";
const BASE = "https://www.anadolusigorta.com.tr";
const LIST_URL = "https://www.anadolusigorta.com.tr/urunler";
...
function detectCategory(title = "", desc = "") {
  ...
  if (/kasko|oto|otomobil|araç|arac|motor/.test(t)) return "car_insurance";
  if (/trafik/.test(t)) return "traffic_insurance";
  if (/konut|ev|dask/.test(t)) return "home_insurance";
  if (/dask|deprem/.test(t)) return "earthquake_insurance";
  if (/sağlık|tamamlayıcı|health/.test(t)) return "health_insurance";
...
// MAIN ADAPTER — S200
// ============================================================================
export async function searchAnadolu(query, regionOrOptions = "TR") {
  const t0 = Date.now();
...
// Aliases — zero delete
export const searchAnadoluScrape = searchAnadolu;
export const searchAnadoluAdapter = searchAnadolu;

export default { searchAnadolu };
